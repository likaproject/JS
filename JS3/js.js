...
// имелось в виду что если при вычислении факториала мы проходим четное число - его нужно умножать на 2 - это то есть нужно делать внутри фунции factorial
if (factorial(n) % 2 == 0){
...
unique(arr);
// все ок только у тебя числа преобразуються в строки что не совсем правильно - переделай так чтобы они оставались числами
